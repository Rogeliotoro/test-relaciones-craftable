...
class FillPermissionsForMechanic extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMechanic constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.mechanic',
            'admin.mechanic.index',
            'admin.mechanic.create',
            'admin.mechanic.show',
            'admin.mechanic.edit',
            'admin.mechanic.delete',
            'admin.mechanic.bulk-delete',
        ]);
